...
class Assignment5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_assihnment5)
    ...
    fun calculateDateOfBirth(dateFormat: SimpleDateFormat, final: String) {
        ...
        val res = "You are $year years - $month months old. \n" +
                "Thank you !!";
    ...
    fun calculateDateJoined(dateFormat: SimpleDateFormat, finalDate: String) {
        ...
        val res =
                "You spent ${year} years ${month} months and ${days} days in this company.";
